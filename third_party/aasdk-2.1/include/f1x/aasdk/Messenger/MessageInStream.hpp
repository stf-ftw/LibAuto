...
private:
    ...
    Message::Pointer createMessageFromRecentFrame();
    Message::Pointer getMessageForRecentFrame();
    ...
    ChannelId recentChannelId_;
    EncryptionType recentEncryptionType_;
    MessageType recentMessageType_;
    ReceivePromise::Pointer promise_;
    std::map<ChannelId, Message::Pointer> partialMessages_;
};
